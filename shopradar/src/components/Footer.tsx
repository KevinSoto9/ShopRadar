function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-white pt-10 pb-6 px-4 flex flex-col items-center">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10 w-full max-w-6xl mb-8">

        {/* Logo + eslogan */}
        <div className="flex flex-col space-y-3">
          <div className="flex items-center space-x-2">
            <img src="/icon.ico" alt="ShopRadar Logo" className="w-8 h-8 object-contain" />
            <span className="text-2xl font-bold">ShopRadar</span>
          </div>
          <p className="text-gray-400 text-sm">
            La forma más inteligente de comparar precios y ahorrar en tus compras.
          </p>
        </div>

        {/* Supermercados */}
        <div>
          <h4 className="text-white font-semibold mb-3">Supermercados disponibles</h4>
        ...
        <div>
          ...
          <ul className="space-y-1 text-gray-400 text-sm">
            ...
            <li><a href="/supermercados" className="hover:text-white">Supermercados</a></li>
  ...
  <a href="/ofertas" className="inline-block mt-2 text-orange-400 hover:underline text-sm">
